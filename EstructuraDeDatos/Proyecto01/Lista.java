...
public class Lista<T> implements Iterable<T> {
	...
	double w =100*getLongitud()-41.8;
	cadena+="<svg width=\"200\" heigth=\"200\">\n";
	cadena+="<g>\n";
	double x=25;
	int c=9;
	int x1=51;//linea recta
	int x2=105;//linea recta 105
	int a1=52;//ini flecha parte sup 52
	int a2=54;//ini flecha parte inf 54
	int b1=106;//fin flecha parte sup 106
	int b2=103;//fin flecha parte inf 103
	int i=0;
	cadena+= " <rect  x=\"0\" y=\"0\" width=\""+w+"\" height=\"40\" style=\"fill:white;stroke:black;stroke-width:.5;fill-opacity:1;stroke-opacity:1\" /> \n";
	while(i < longitud){
	    
	    cadena+= " <rect  x=\""+c+"\" y=\"5\" width=\"40\" height=\"30\" style=\"fill:white;stroke:blue;stroke-width:1;fill-opacity:0.7;stroke-opacity:1\" /> \n";
	    
	    cadena+=" <text fill=\"black\" x=\""+x+"\" y=\"23\" >"+get(i)+"</text> \n";
	    if(i!=(longitud-1)){
		cadena+=" <line x1=\""+x1+"\" y1=\"18\" x2=\""+x2+"\" y2=\"18\" style=\"stroke:black;stroke-width:2\"/>\n";
		cadena+=" <line x1=\""+a1+"\" y1=\"19\" x2=\""+a2+"\" y2=\"13\" style=\"stroke:black;stroke-width:2\"/>\n";
		cadena+=" <line x1=\""+a1+"\" y1=\"17\" x2=\""+a2+"\" y2=\"23\" style=\"stroke:black;stroke-width:2\"/>\n";
		cadena+=" <line x1=\""+b1+"\" y1=\"19\" x2=\""+b2+"\" y2=\"13\" style=\"stroke:black;stroke-width:2\"/>\n";
		cadena+=" <line x1=\""+b1+"\" y1=\"17\" x2=\""+b2+"\" y2=\"23\" style=\"stroke:black;stroke-width:2\"/>\n";
	    }
	    b1+=100;
	    b2+=100;
	    a1+=100;
